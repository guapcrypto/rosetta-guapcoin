...
import (
	...
	guap "github.com/guapcrypto/rosetta-guapcoin/guap"

	mock "github.com/stretchr/testify/mock"

	types "github.com/guapcrypto/rosetta-sdk-go/types"
)
...
func (_m *Indexer) GetScriptPubKeys(_a0 context.Context, _a1 []*types.Coin) ([]*guap.ScriptPubKey, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*guap.ScriptPubKey
	if rf, ok := ret.Get(0).(func(context.Context, []*types.Coin) []*guap.ScriptPubKey); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*guap.ScriptPubKey)
		}
	}
