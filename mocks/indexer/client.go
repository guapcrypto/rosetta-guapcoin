...
func (_m *Client) GetRawBlock(_a0 context.Context, _a1 *types.PartialBlockIdentifier) (*guap.Block, []string, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *guap.Block
	if rf, ok := ret.Get(0).(func(context.Context, *types.PartialBlockIdentifier) *guap.Block); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*guap.Block)
		}
	}
