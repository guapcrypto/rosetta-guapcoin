...
const (
	...
	// of rosetta-guap. We set this as a
...
type unsignedTransaction struct {
	...
	ScriptPubKeys  []*guap.ScriptPubKey `json:"scriptPubKeys"`
...
type constructionMetadata struct {
	ScriptPubKeys []*guap.ScriptPubKey `json:"script_pub_keys"`
}
...
type ParseOperationMetadata struct {
	ScriptPubKey *guap.ScriptPubKey `json:"scriptPubKey"`
}
